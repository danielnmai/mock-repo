public class Cipmyt {
    public static void main() {
        ...
        System.out.println("tyobe");
        System.out.println("crsrh");
        System.out.println("esiut");
        System.out.println("jdbmu");
        System.out.println("tbafl");
        System.out.println("xobay");
        System.out.println("kuipx");
        System.out.println("snlej");
        System.out.println("tysnj");
        System.out.println("jobyr");
        System.out.println("uxhln");
        System.out.println("mlxjj");
    }
}
